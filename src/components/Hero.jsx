  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className="text-[#915eff]">Shrestha Tripathi</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            A fullstack security-focused Software Engineer <br className="sm:block hidden"/> dedicated to developing robust
      ...
      <div className="flex justify-center">
        <img src={avatar}  className="relative top-[300px]"/>
      </div>
      {/* <ComputersCanvas /> */}
